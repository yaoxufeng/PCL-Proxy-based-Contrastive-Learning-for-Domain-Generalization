...
class MultipleEnvironmentImageFolder(MultipleDomainDataset):
    def __init__(self, root):
        ...
        # environments = ["painting", "infograph", "clipart", "quickdraw", "real", "sketch"]  # test
        # environments = ["infograph", "painting", "clipart", "quickdraw", "real", "sketch"]  # test
        # environments = ["clipart", "painting", "infograph", "quickdraw", "real", "sketch"]  # test
